...
const hoHi = JSON.parse(
  fs.readFileSync(path.join(root, '../../BabyCare/babycare-app/src/locales/hi.json'), 'utf8'),
);
const hoMr = JSON.parse(
  fs.readFileSync(path.join(root, '../../BabyCare/babycare-app/src/locales/mr.json'), 'utf8'),
);
